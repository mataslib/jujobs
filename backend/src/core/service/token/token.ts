...
const _createSignedToken = async (
  ...
  return new SignJWT(payload)
    ...
    .setIssuedAt(createdAt.valueOf() / 1000)
    .setExpirationTime(expireAt.valueOf() / 1000)
    .sign(privateKey);
};
...
export const createSignedToken = async (
  ...
  return _createSignedToken(privateKeyString, payload, createdAt, expireAt);
};
